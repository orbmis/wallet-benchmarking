...
The seed dataset originates from [**Walletbeat**](https://github.com/walletbeat/walletbeat)
([walletbeat.eth](https://walletbeat.eth)), an open community project benchmarking
Ethereum wallets. See [Acknowledgements](#acknowledgements).
...
[Walletbeat](https://github.com/walletbeat/walletbeat) and extended here:
...
The original seed data for this benchmark comes from
[**Walletbeat**](https://github.com/walletbeat/walletbeat) — an open community
project benchmarking Ethereum wallets ([walletbeat.eth](https://walletbeat.eth),
[@walletbeat](https://x.com/walletbeat)). This project builds on that dataset
with additional metrics, evidence, and the interactive HTML views described
